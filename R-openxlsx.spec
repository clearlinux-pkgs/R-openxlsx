...
Version  : 4.2.7
Release  : 66
URL      : https://cran.r-project.org/src/contrib/openxlsx_4.2.7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/openxlsx_4.2.7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725308995
