...
Version  : 4.1.4
Release  : 32
URL      : https://cran.r-project.org/src/contrib/openxlsx_4.1.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/openxlsx_4.1.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575906631
