...
Version  : 4.1.2
Release  : 28
URL      : https://cran.r-project.org/src/contrib/openxlsx_4.1.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/openxlsx_4.1.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572367057
